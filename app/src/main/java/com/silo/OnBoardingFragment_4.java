...
import com.silo.databinding.FragmentOnBoarding4Binding;
...
public class OnBoardingFragment_4 extends Fragment {
    ...
    public static OnBoardingFragment_4 newInstance() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fullText = getString(R.string.onboarding_text_3);
    ...
    public void onResume() {
        ...
        if (binding != null) {
            ...
            typingAnimator.startTyping(binding.tvOnBoarding4, fullText, 1300, 100);
